...
const INVESTMENT_OPPORTUNITIES = [
  {
    ...
    roi: 28.5, risk: 'medium',
    growth: '+25% YoY',
    reason: 'Vision 2030 mega project',
    reasonAr: 'مشروع رؤية 2030',
    pricePerSqm: 15000,
  },
  {
    ...
    roi: 12.3, risk: 'low',
    growth: '+5.2% YoY',
    reason: 'Premium business district',
    reasonAr: 'حي الأعمال المميز',
    pricePerSqm: 12000,
  },
  {
    ...
    roi: 15.8, risk: 'low',
    growth: '+7.5% YoY',
    reason: 'Tourism and sea views',
    reasonAr: 'السياحة والإطلالة البحرية',
    pricePerSqm: 13000,
  },
  {
    area: 'Red Sea Project Area', areaAr: 'منطقة مشروع البحر الأحمر',
    roi: 22.1, risk: 'medium',
    growth: '+18% YoY',
    reason: 'Luxury tourism development',
    reasonAr: 'تطوير السياحة الفاخرة',
    pricePerSqm: 18000,
  },
  {
    area: 'Qiddiya, Riyadh', areaAr: 'القدية، الرياض',
    roi: 19.5, risk: 'medium',
    growth: '+15% YoY',
    reason: 'Entertainment city project',
    reasonAr: 'مشروع مدينة الترفيه',
    pricePerSqm: 8500,
  },
];
