// Mirror of apps/mobile/scripts/translate-new-keys.js, but pointed at the
// shared @eawlma/i18n-locales package directory. Used to back-fill missing
// keys in every non-English locale after editing en.json.
//
// Usage: node packages/i18n-locales/scripts/translate-new-keys.js
const fs = require('fs');
