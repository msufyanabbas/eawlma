          ...
          <RTLChart height={320}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={views.map((p) => ({ date: p.date.slice(5), Impressions: p.impressions, Views: p.detailViews, Inquiries: p.inquiries }))}>
                ...
                <XAxis dataKey="date" tickFormatter={translateLabel} stroke={theme.palette.text.secondary} fontSize={12} />
                <YAxis tickFormatter={formatNumber} stroke={theme.palette.text.secondary} fontSize={12} allowDecimals={false} />
                <RechartsTooltip
